...
public class BasketballFacilityDto extends SportsFacilityDto {
    ...
    public BasketballFacilityDto(String id, double pricePerHours, boolean access, FieldDto field, String name, String type, int numberOfBasket, double minHeightOfBasket, double maxHeightOfBasket) {
