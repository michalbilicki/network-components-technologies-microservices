...
public class Consts {
    ...
    public static final String ADD_ACCOUNT_QUEUE = "ADD_ACCOUNT_QUEUE";
    public static final String REMOVE_ACCOUNT_QUEUE = "REMOVE_ACCOUNT_QUEUE";
    public static final String UPDATE_ACCOUNT_QUEUE = "UPDATE_ACCOUNT_QUEUE";
    public static String BLOCK_ACCOUNT_QUEUE = "BLOCK_ACCOUNT_QUEUE";
    public static String UNBLOCK_ACCOUNT_QUEUE = "UNBLOCK_ACCOUNT_QUEUE";
